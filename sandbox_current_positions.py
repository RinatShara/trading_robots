...
with Client(sb_token) as client:
	...
	positions = client.sandbox.get_sandbox_portfolio(account_id='ebb8b629-1ad7-4f1d-a93f-09fb93e32487').positions
	df = pd.DataFrame([{'Название': get_name(item.figi) if item.figi != 'FG0000000000' else 'Рубль',
