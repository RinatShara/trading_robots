...
# Form implementation generated from reading ui file 'testing_mode.ui'
#
...
class Ui_TestingWindow(object):
    def setupUi(self, TestingWindow):
        ...
        self.bg2_label.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0.994318, y2:0, stop:0.375 rgba(119, 67, 219, 255), stop:0.426136 rgba(119, 105, 219, 255));")
        ...
        self.calendar.setGeometry(QtCore.QRect(420, 288, 241, 170))
        font = QtGui.QFont()
...
"}\n"
"")
        self.calendar.setSelectedDate(QtCore.QDate(2022, 11, 23))
...
"")
        ...
        self.error_label.setGeometry(QtCore.QRect(339, 20, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
...
"")
    ...
    def retranslateUi(self, TestingWindow):
        ...
        self.set_param_btn.setToolTip(_translate("TestingWindow", "<html><head/><body><p>Задать дополнительные параметры</p></body></html>"))
        ...
        self.hist_tests_btn.setToolTip(_translate("TestingWindow", "<html><head/><body><p>Исторические тесты</p></body></html>"))
        ...
        self.current_time.setText(_translate("TestingWindow", "22:34"))
